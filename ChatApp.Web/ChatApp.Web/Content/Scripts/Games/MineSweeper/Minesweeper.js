...
Minesweeper.prototype =
{
	...
	__createEZGUIScreens: function ()
	{
		...
		EZGUI.components.tb_new_game.on('click', this.__onToolbarButtonClicked.bind(this));
		EZGUI.components.tb_restart.on('click', this.__onToolbarButtonClicked.bind(this));
		//create the game
		...
		children: [
			{
				...
				layout: [8, 1],
				children: [
					{ id: 'tb_new_game', text: 'New game', userData: "new", component: 'Button', position: 'center', width: 50, height: 50, skin: 'levelBtn' },
					{ id: 'tb_restart', text: 'Restart', userData: "restart", component: 'Button', position: 'center', width: 50, height: 50, skin: 'levelBtn' },
					null,
					null,
					{ id: 'tb_timer_img', text: '', component: 'Button', position: 'center', width: 50, height: 50, skin: 'levelBtn' },
					{ id: 'tb_timer_lbl', text: '0', component: 'Label', position: 'left', width: 50, height: 50, skin: 'levelBtn' },
					{ id: 'tb_mines_img', text: '', component: 'Button', position: 'center', width: 50, height: 50, skin: 'levelBtn' },
					{ id: 'tb_mines_lbl', text: '19', component: 'Label', position: 'left', width: 50, height: 50, skin: 'levelBtn' },
